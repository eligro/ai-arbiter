    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-background flex items-center justify-center p-4">
      ...
      >
        <div className="text-center">
          <h1 className="text-3xl font-bold text-text">Join AI Arbiter</h1>
          <p className="text-text-secondary mt-2">Create your account with Google to start resolving disputes.</p>
        </div>
